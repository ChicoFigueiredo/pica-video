...
def processar_frames_com_opencv(caminho_video, pasta_saida, fps_extracao=4):
...
def main():
    ...
    for caminho_video in arquivos_video:
        try:
            ...
            processo_frames = threading.Thread(target=processar_frames_com_opencv, args=(caminho_video, pasta_saida))
