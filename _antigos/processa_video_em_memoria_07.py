...
def texto_legivel(texto, porcentagem_minima=40.0):
    """Verifica se o texto é legível e está em português, baseado na porcentagem mínima de palavras legíveis."""
    try:
...
def processar_frames_com_opencv(caminho_video, pasta_saida, fps_extracao=4, porcentagem_minima=40.0):
        ...
        while True:
            ...
            if frame_num % frame_intervalo == 0:
                try:
                    ...
                    if texto.strip() and texto_legivel(texto, porcentagem_minima):
...
def main():
    ...
    for caminho_video in arquivos_video:
        try:
            ...
            processo_frames = threading.Thread(target=processar_frames_com_opencv, args=(caminho_video, pasta_saida, 4, porcentagem_minima))
